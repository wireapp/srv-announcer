...
func main() {
	...
	app.Flags = []cli.Flag{
		...
		&cli.StringFlag{
			...
			Usage:       "RFC2783 Name (_service._proto.name)",
		...
		&cli.UintFlag{
			Name:        "srv-record-ttl",
			Usage:       "TTL of the RFC2783 SRV Record Set in seconds",
		...
		&cli.UintFlag{
			...
			Usage:       "Priority of the RFC2783 SRV Record",
		...
		&cli.UintFlag{
			...
			Usage:       "Weight of the RFC2783 SRV Record",
		...
		&cli.UintFlag{
			...
			Usage:       "Port of the RFC2783 SRV Record",
		...
		&cli.StringFlag{
			...
			Usage:       "Target of the RFC2783 SRV Record. Usualy something resembling your hostname.",
